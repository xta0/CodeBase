...
function process() {
    return __awaiter(this, void 0, void 0, function () {
        var stats, _i, _a, dSYMPath;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    stats = [];
                    for (_i = 0, _a = ['x.js', 'app.ts']; _i < _a.length; _i++) {
                        dSYMPath = _a[_i];
                        stats.push(fs_1["default"].promises.stat(dSYMPath));
                    }
                    return [4 /*yield*/, Promise.all(stats)];
                case 1: return [2 /*return*/, (_b.sent()).map(function (stat) { return stat.mtime.getTime(); })];
            }
        });
    });
}
